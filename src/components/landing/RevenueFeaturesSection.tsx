...
export default function RevenueFeaturesSection() {
  return (
    <Box id="services" component="section" sx={{ py: { xs: 8, md: 10 }, bgcolor: 'background.default' }}>
      <Container maxWidth="lg">
        ...
        >
          Everything you need to manage property tax payments in one secure platform.
        </Typography>
              ...
              <Grid key={feature.title} size={{ xs: 12, md: 4 }}>
                ...
                >
                  ...
                  >
                    ...
                    <Typography variant="h5" color="secondary.main" sx={{ fontWeight: 700, mb: 1 }}>
                      {feature.title}
                    </Typography>
