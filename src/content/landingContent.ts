...
export const heroSlides = [
  {
    ...
    subtext:
      'Manage your property taxes with ease. Secure, fast, and reliable mobile money payments.',
    cta: { label: 'Get Started', href: '/register' },
  },
  {
    image: '/assets/landing/hero-mobile.jpg',
    headline: 'Pay Property Tax in Minutes.',
    subtext: 'Pay via MTN MoMo, Telecel Cash, or AT Mobile Money — anytime, anywhere.',
    cta: { label: 'Create Account', href: '/register' },
  },
  {
    image: '/assets/landing/hero-property.jpg',
    headline: 'Track Bills. Get SMS Alerts.',
    subtext: 'View payment history, receive bill reminders, and download receipts instantly.',
...
export const howItWorksSteps = [
  {
    step: 1,
    title: 'Register',
    description: 'Create your account with your phone number and property details.',
  ...
  },
  {
    step: 3,
    title: 'View Bill',
    description: 'See your property tax breakdown, arrears, and due dates.',
    icon: 'bill' as const,
  },
  {
    step: 4,
    title: 'Pay via MoMo',
    description: 'Approve payment on your phone through your mobile money network.',
    icon: 'momo' as const,
  },
] as const;
...
export const whyKashdaItems = [
  {
    ...
    description: 'Payments processed through trusted MoMo networks with encrypted transactions.',
    icon: 'security' as const,
  },
  {
    title: 'Ghana Post GPS',
    description: 'Register your property using Ghana Post GPS, pin location, or map links.',
  ...
  },
  {
    ...
    description: 'Manage bills, payments, and profile anytime from your dashboard.',
    icon: 'clock' as const,
  },
] as const;
...
export const visionContent = {
  title: 'Our Vision',
  paragraphs: [
    'KASHDA is building accessible digital revenue collection for Ghana — starting with property tax. We believe every property owner deserves a simple, transparent way to pay government obligations without queues or paperwork.',
  ...
  aboutText:
    'KASHDA empowers Ghanaian property owners to manage tax payments through a secure, mobile-first platform. Pay with MoMo, track bills, and receive SMS alerts — all in one place.',
} as const;
...
export const authTagline = {
  ...
  subtext: 'Secure property tax payments for every Ghanaian property owner.',
